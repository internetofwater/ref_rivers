...
Store the URI identifier, never the `reference.geoconnex.us` URL you land on after the redirect — see [Reference Features](https://docs.geoconnex.us/reference/reference_features).
