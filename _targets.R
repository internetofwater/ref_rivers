...
list(
  ...
  tar_target(ref_rivers_v21, get_ref_rivers(version = "v2.1", sha256sum = "a9161151f3513206b6d5348c827dca6cbc4df147f8de98847ad1fa1e58a6a099")),
  ...
  tar_target(mainstems, make_mainstems(mainstems_v2, 
                                       ...
                                       "out/mainstems.gpkg")),
  tar_target(non_ref_mainstems, make_nonref(mainstems, ref_net_v1)),
